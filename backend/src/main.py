...
from src.modules.policy.api.error_handler import (  # noqa: E402
    register_policy_error_handlers,
)
from src.modules.policy.api.evaluation_router import evaluation_router  # noqa: E402
from src.modules.policy.api.router import policy_router  # noqa: E402
...
register_policy_error_handlers(app)
